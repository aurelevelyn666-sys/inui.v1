...
export function buildSystemPrompt({ files, mcpTools, overrides, skills }) {
  ...
  return [
    ...
    '6. COMPLETE SCAFFOLD BY DEFAULT: every site ships as many small focused files — /App.jsx composes sections; one component per file under /components/ (e.g. /components/Navbar.jsx, /components/Hero.jsx, /components/Pricing.jsx, /components/Footer.jsx); separate views under /pages/ when routing is asked; shared stateful logic under /hooks/ (e.g. /hooks/useMenu.js); helpers under /lib/ (e.g. /lib/format.js); shared styles in /index.css. Never stuff a whole site into one file. EXCEPTION: only when the user explicitly asks for a single file / single component, honor it and return just that file.',
